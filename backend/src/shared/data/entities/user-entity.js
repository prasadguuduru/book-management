...
exports.USER_ROLE_PERMISSIONS = exports.UserEntityMapper = void 0;
class UserEntityMapper {
    /**
     * Convert User domain object to DynamoDB entity
     */
    static toDynamoDBEntity(user, encryptedEmail, encryptedFirstName, encryptedLastName, hashedPassword) {
        return {
            PK: `USER#${user.userId}`,
            SK: 'PROFILE',
            entityType: 'USER',
     ...
     */
    static fromDynamoDBEntity(entity, decryptedEmail, decryptedFirstName, decryptedLastName) {
        return {
