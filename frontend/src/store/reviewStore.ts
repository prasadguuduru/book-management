...
interface ReviewActions {
  ...
  updateReview: (reviewId: string, reviewData: Partial<CreateReviewRequest>) => Promise<Review>
...
export const useReviewStore = create<ReviewStore>((set: any) => ({
  ...
  updateReview: async (reviewId: string, reviewData: Partial<CreateReviewRequest>) => {
    set({ isLoading: true, error: null })
